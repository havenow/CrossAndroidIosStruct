...
public:
	TAesClass();
	~TAesClass();
  void InitializePrivateKey(unsigned long KeySize,unsigned char *KeyBytes);                       //AES 密钥初始化
	unsigned long OnAesEncrypt(void* InBuffer,unsigned long InLength,void* OutBuffer);			//AES 加密数据
	unsigned long OnAesUncrypt(void* InBuffer,unsigned long InLength,void* OutBuffer);			//AES 解密数据
private:
	Aes  * m_lpAes;
};
